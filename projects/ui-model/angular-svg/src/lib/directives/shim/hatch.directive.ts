...
export class SvgHatchDirective {
  ...
  get hatchContentUnits(): string {
    return getAttr(this.elementRef, 'hatchContentUnits');
  }

  @Input('hatchContentUnits')
  set hatchContentUnits(value: string) {
    setAttr(this.elementRef, 'hatchContentUnits', value);
  }


  get hatchUnits(): string {
    return getAttr(this.elementRef, 'hatchUnits');
  }

  @Input('hatchUnits')
  set hatchUnits(value: string) {
    setAttr(this.elementRef, 'hatchUnits', value);
  }
  ...
  get pitch(): string {
    return getAttr(this.elementRef, 'pitch');
  }

  @Input('pitch')
  set pitch(value: string) {
    setAttr(this.elementRef, 'pitch', value);
  }
