...
export class SvgMaskDirective {
  ...
  get maskContentUnits(): string {
    return getAttr(this.elementRef, 'maskContentUnits');
  }

  @Input('maskContentUnits')
  set maskContentUnits(value: string) {
    setAttr(this.elementRef, 'maskContentUnits', value);
  }
