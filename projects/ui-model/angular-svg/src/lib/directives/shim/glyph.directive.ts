...
export class SvgGlyphDirective {
  ...
  get arabicForm(): string {
    return getAttr(this.elementRef, 'arabic-form');
  }

  @Input('arabic-form')
  set arabicForm(value: string) {
    setAttr(this.elementRef, 'arabic-form', value);
  }
  ...
  get lang(): string {
    return getAttr(this.elementRef, 'lang');
  }

  @Input('lang')
  set lang(value: string) {
    setAttr(this.elementRef, 'lang', value);
  }
  ...
  get orientation(): string {
    return getAttr(this.elementRef, 'orientation');
  }

  @Input('orientation')
  set orientation(value: string) {
    setAttr(this.elementRef, 'orientation', value);
  }
