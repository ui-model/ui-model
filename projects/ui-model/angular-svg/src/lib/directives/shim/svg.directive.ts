...
export class SvgSvgDirective {
  ...
  get baseProfile(): string {
    return getAttr(this.elementRef, 'baseProfile');
  }

  @Input('baseProfile')
  set baseProfile(value: string) {
    setAttr(this.elementRef, 'baseProfile', value);
  }
  ...
  get version(): string {
    return getAttr(this.elementRef, 'version');
  }

  @Input('version')
  set version(value: string) {
    setAttr(this.elementRef, 'version', value);
  }
