...
export class SvgPatternDirective {
  ...
  get patternContentUnits(): string {
    return getAttr(this.elementRef, 'patternContentUnits');
  }

  @Input('patternContentUnits')
  set patternContentUnits(value: string) {
    setAttr(this.elementRef, 'patternContentUnits', value);
  }
