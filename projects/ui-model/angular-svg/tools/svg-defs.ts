...
// download from https://github.com/svg/svgo/blob/5d97108687bc6400d6daabed2651db173483f8ff/plugins/_collections.js
...
export const elems: Record<string, ElementDef> = {
  a: {
    attrsGroups: [
